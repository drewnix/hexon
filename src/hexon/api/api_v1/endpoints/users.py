...
from hexon.api.deps import CurrentUser, SessionDep, get_current_active_superuser
from hexon.core.config import settings
from hexon.models import User, UserCreate, UserCreateOpen, UserOut
from hexon.utils import send_new_account_email
...
@router.get("/{user_id}")
def read_user_by_id(user_id: int, session: SessionDep, current_user: CurrentUser) -> UserOut:
    """
    Get a specific user by id.
    """
    user = session.get(User, user_id)  # type: ignore[attr-defined]
